...
(async () => {
  ...
  const populateProductsStmt = `
    ...
    VALUES
      ...
      ('SeaRey', 1000000, 'The Progressive Aerodyne Searey is an American two-seat, single-engine, amphibious flying boat designed and manufactured by Progressive Aerodyne originally in Orlando, Florida, and now in Tavares, Florida.', '../public/searey.webp'),
